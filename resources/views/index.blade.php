                                ...
                                <div
                                    ...
                                    <div class="space-y-5">
                                        <div class="flex items-center justify-between">
                                            <div class="flex items-center gap-3">
                                                <div class="w-full max-w-8 items-center rounded-full">
                                                    <img src="{{ asset('images/country/country-01.svg') }}"
                                                        alt="usa" />
                                                </div>
                                                <div>
                                                    <p
                                        ...
                                        <div class="flex items-center justify-between">
                                            <div class="flex items-center gap-3">
                                                <div class="w-full max-w-8 items-center rounded-full">
                                                    <img src="{{ asset('images/country/country-02.svg') }}"
                                                        alt="france" />
                                                </div>
                                                <div>
                                                    <p
                                                ...
                                                <tr>
                                                    <td class="py-3">
                                                        <div class="flex items-center">
                                                            <div class="flex items-center gap-3">
                                                                <div class="h-[50px] w-[50px] overflow-hidden rounded-md">
                                                                    <img src="{{ asset('images/product/product-02.jpg') }}"
                                                                        alt="Product" />
                                                                </div>
                                                                <div>
                                                                    <p
                                                ...
                                                <tr>
                                                    <td class="py-3">
                                                        <div class="flex items-center">
                                                            <div class="flex items-center gap-3">
                                                                <div class="h-[50px] w-[50px] overflow-hidden rounded-md">
                                                                    <img src="{{ asset('images/product/product-03.jpg') }}"
                                                                        alt="Product" />
                                                                </div>
                                                                <div>
                                                                    <p
                                                ...
                                                <tr>
                                                    <td class="py-3">
                                                        <div class="flex items-center">
                                                            <div class="flex items-center gap-3">
                                                                <div class="h-[50px] w-[50px] overflow-hidden rounded-md">
                                                                    <img src="{{ asset('images/product/product-04.jpg') }}"
                                                                        alt="Product" />
                                                                </div>
                                                                <div>
                                                                    <p
                                                ...
                                                <tr>
                                                    <td class="py-3">
                                                        <div class="flex items-center">
                                                            <div class="flex items-center gap-3">
                                                                <div class="h-[50px] w-[50px] overflow-hidden rounded-md">
                                                                    <img src="{{ asset('images/product/product-05.jpg') }}"
                                                                        alt="Product" />
                                                                </div>
                                                                <div>
                                                                    <p

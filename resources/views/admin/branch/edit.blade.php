...
@section('title', 'Branch Edit | WokaCash')
...
@section('content')
    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mt-5 flex items-center justify-between">
            <h2 class="text-2xl font-semibold text-gray-800 dark:text-white">Edit Branch</h2>
        ...
        <div class="bg-white dark:bg-gray-900 rounded-xl shadow p-6">
            ...
            <form id="userCreateForm" action="{{ route('admin.branch.update', $branch->id) }}" method="POST" enctype="multipart/form-data">
                @csrf @method('PUT')
        ...
        flex justify-between items-center">
                        ...
                        <!-- Hidden real input -->
                        <input type="hidden" name="user" id="userInput" value="{{ $branch->user_id }}">
        ...
        bg-white dark:bg-gray-800 shadow-lg">
            ...
            placeholder-gray-400 dark:placeholder-white/30"
                    ...
                    <div>
                        ...
                        <input value="{{ $branch->name }}" type="text" name="name_branches"
                            class="w-full h-11 px-4 rounded-lg border border-gray-300 dark:border-gray-700 
                            bg-white dark:bg-gray-800 text-gray-800 dark:text-white 
                            placeholder-gray-400 dark:placeholder-white/30
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            bg-white dark:bg-gray-800 text-gray-800 dark:text-white 
                            focus:ring-2 focus:ring-brand-400 focus:border-brand-500 outline-none"
                            name="address" id="" cols="30" rows="5">{{ $branch->address }}</textarea>
                    </div>
                </div>
    ...
    <script>
        ...
        if (currentUserId) {
            const selectedLi = [...userList.querySelectorAll("li")]
                .find(li => li.dataset.id === currentUserId);

            if (selectedLi) {
                selectedUser.textContent = selectedLi.textContent.trim();
        ...
        searchUser.addEventListener("input", () => {
            ...
            noUserFound.classList.toggle("hidden", found);
        });
        ...
        userList.querySelectorAll("li").forEach((li) => {
            li.addEventListener("click", () => {
                ...
                selectedUser.textContent = li.textContent.trim();

...
@section('title', 'User Edit | WokaCash')
...
@section('content')
    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mt-5 flex items-center justify-between">
            <h2 class="text-2xl font-semibold text-gray-800 dark:text-white">Edit User</h2>
        ...
        <div class="bg-white dark:bg-gray-900 rounded-xl shadow p-6">
            ...
            <form id="userCreateForm" action="{{ route('admin.user.update', $user->id) }}" method="POST"
                ...
                <div class="mt-6">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div class="w-20 h-20 rounded-full overflow-hidden border border-brand-300 dark:border-gray-700 bg-gray-100 dark:bg-gray-800"
                            id="preview-wrapper">
                            <img id="preview-image" src="{{ asset('storage/' . $user->photo_profile) }}" alt=""

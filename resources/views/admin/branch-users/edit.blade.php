...
@section('title', 'Branch User Edit | WokaCash')
...
@section('content')
    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mt-5 flex items-center justify-between">
            <h2 class="text-2xl font-semibold text-gray-800 dark:text-white">Edit Branch User</h2>
        ...
        <div class="bg-white dark:bg-gray-900 rounded-xl shadow p-6">
            ...
            <form id="userCreateForm" action="{{ route('admin.branchUser.update', $branchUser->id) }}" method="POST"
        ...
        bg-white dark:bg-gray-800 text-gray-800 dark:text-white flex justify-between items-center">
                        ...
                        <input type="hidden" name="branch" class="realInput" value="{{ $branchUser->branch_id }}">
        ...
        bg-white dark:bg-gray-800 text-gray-800 dark:text-white flex justify-between items-center">
                        ...
                        <input type="hidden" name="user" class="realInput" value="{{ $branchUser->user_id }}">
        ...
        dark:border-gray-700 dark:bg-gray-800 shadow-lg">
            ...
            bg-white dark:bg-gray-900 text-gray-800 dark:text-white placeholder-gray-400 dark:placeholder-white/30"
                    ...
                    <div>
                        ...
                        <input value="{{ $branchUser->role_in_branch }}" type="text" name="role_in_branch"
    ...
    <script>
        document.querySelectorAll(".fake-select").forEach(select => {
            ...
            const dropdownButton = select.querySelector(".dropdownButton");
            const dropdownMenu = select.querySelector(".dropdownMenu");
            const searchInput = select.querySelector(".searchInput");
            const itemList = select.querySelectorAll(".itemList li");
            ...
            if (realInput.value) {
                const selectedLi = [...itemList].find(li => li.dataset.id === realInput.value);

                if (selectedLi) {
                    selectedText.textContent = selectedLi.textContent.trim();
                    selectedLi.classList.add("bg-gray-100", "dark:bg-gray-700");
                }
            }
            ...
            itemList.forEach(li => {
                li.addEventListener("click", () => {
                    ...
                    itemList.forEach(item => item.classList.remove("bg-gray-100",
                        "dark:bg-gray-700"));
            ...
            document.addEventListener("click", e => {
                if (!select.contains(e.target)) dropdownMenu.classList.add("hidden");
            });
        });

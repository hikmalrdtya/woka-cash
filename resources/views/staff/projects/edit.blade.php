...
@section('content')
    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white dark:bg-gray-900 rounded-xl mt-4 shadow p-6">
            ...
            <form id="userCreateForm" action="{{ route('staff.projects.update', $project->id) }}" method="POST"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="description" rows="3" 
                            class="w-full border border-gray-300/50 dark:border-gray-600/50 bg-white/50 dark:bg-gray-700/50 rounded-xl px-3 py-2.5 dark:text-white">{{ $project->description }}</textarea>

        ...
        <nav x-data="{ selected: $persist('Dashboard') }">
            ...
            <div>
                ...
                <ul class="flex flex-col gap-4 mb-6">
                    <!-- Menu Item Dashboard -->
                    <li>
                        <a href="{{ route('admin.dashboard') }}" @click.prevent="selected = (selected === 'Dashboard' ? '':'Dashboard')"
                    ...
                    <!-- Menu Item User -->
                    <li>
                        <a href="{{ route('admin.user.index') }}" @click="selected = (selected === 'User' ? '':'User')"
                            class="menu-item group"
                            :class="(selected === 'User') && (page === 'user') ? 'menu-item-active' :
                            'menu-item-inactive'">
                            <svg :class="(selected === 'User') && (page === 'user') ? 'menu-item-icon-active' :
                            'menu-item-icon-inactive'"
                                width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"

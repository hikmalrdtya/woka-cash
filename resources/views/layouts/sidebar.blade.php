        ...
        <nav x-data="{ selected: $persist('Dashboard') }">
            ...
            <div>
                ...
                <ul class="flex flex-col gap-4 mb-6">
                    ...
                    <!-- Menu Item User -->
                    <li>
                        <a href="{{ route('admin.user.index') }}" class="menu-item group
                    ...
                    <!-- Menu Item Branch -->
                    <li>
                        <a href="{{ route('admin.branch.index') }}" class="menu-item group
                                    {{ request()->routeIs('admin.user.*') ? 'menu-item-active' : 'menu-item-inactive' }}">
                            <svg class="{{ request()->routeIs('admin.user.*') ? 'menu-item-icon-active' : 'menu-item-icon-inactive' }}"
                                width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                    ...
                    <!-- Menu Item Branch Users -->
                    <li>
                        <a href="{{ route('admin.branchUser.index') }}" class="menu-item group
                                    {{ request()->routeIs('admin.user.*') ? 'menu-item-active' : 'menu-item-inactive' }}">
                            <svg class="{{ request()->routeIs('admin.user.*') ? 'menu-item-icon-active' : 'menu-item-icon-inactive' }}"
                                width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li>
                        <a href="" class="menu-item group {{ request()->routeIs('admin.user.*') ? 'menu-item-active' : 'menu-item-inactive' }}">
                            <svg class="{{ request()->routeIs('admin.user.*') ? 'menu-item-icon-active' : 'menu-item-icon-inactive' }}"
                                width="24" height="24"
                                viewBox="0 0 24 24"
                                fill="none"

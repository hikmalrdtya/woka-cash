                    ...
                    @if (Auth::check() && (Auth::user()->role === 'finance'))
                        <li>
                            <a href="{{ route('finance.dashboard') }}"
                                class="menu-item group {{ request()->routeIs('finance.dashboard') ? 'menu-item-active' : 'menu-item-inactive' }}">
                        ...
                        <li>
                            <a href="{{ route('finance.incomes.index') }}"
                                class="menu-item group {{ request()->routeIs('finance.incomes.*') ? 'menu-item-active' : 'menu-item-inactive' }}">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"
                                    xmlns="http://www.w3.org/2000/svg">

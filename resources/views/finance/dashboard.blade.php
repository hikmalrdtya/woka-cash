    ...
    <body
                        ...
                        <div class="grid grid-cols-12 gap-4 md:gap-6">
                            <div class="col-span-12 space-y-6 xl:col-span-7">
                                ...
                                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-6">
                                    ...
                                    {{ $incomeChange >= 0 ? 'bg-success-50 text-success-600 dark:bg-success-500/15 dark:text-success-500'
        : 'bg-error-50 text-error-600 dark:bg-error-500/15 dark:text-error-500' }}
                                    py-0.5 pl-2 pr-2.5 text-sm font-medium">
                                                ...
                                                @else
                                                    ▼ {{ number_format(abs($incomeChange), 2) }}%
                                                @endif
                                            </span>
                                        </div>
                                    </div>
                                    ...
                                    <div
                                        ...
                                        <div class="mt-5 flex items-end justify-between">
                                            ...
                                            <span class="flex items-center gap-1 rounded-full 
                                {{ $expenseChange >= 0 ? 'bg-error-50 text-error-600 dark:bg-error-500/15 dark:text-error-500'
        : 'bg-success-50 text-success-600 dark:bg-success-500/15 dark:text-success-500' }}
                                py-0.5 pl-2 pr-2.5 text-sm font-medium">
                                                ...
                                                @else
                                                    ▼ {{ number_format(abs($expenseChange), 2) }}%
                                                @endif
                                            </span>
                                        </div>
                                    </div>
                                ...
                                <div
                                    ...
                                    <div class="mt-5">
                                        <span class="text-sm text-gray-500 dark:text-gray-400">
                                            Net Balance (All Branch)
                                        </span>
                                        <h4 class="mt-2 text-title-sm font-bold 
                            {{ $netBalance >= 0 ? 'text-success-600' : 'text-error-600' }}">
